		...
		<form action="" method="post" enctype="multipart/form-data">
					...
					<table align="center" width="350" style="margin-left:250px;">
						...
						<tr>
							...
							<td><input type="file" name="c_image"/><img src="customer_images/<?php echo $image; ?>" style="height:100px;width:90px;"/></td>
						</tr>
